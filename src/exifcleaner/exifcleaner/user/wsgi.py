"""
WSGI Applications That Provide a REST-ish API for the UserManager.
"""
...
class UserService(common.wsgi.BaseService):
    """
    ...
    def __init__(self, redis_url="redis://127.0.0.1:6379"):
        common.wsgi.BaseService.__init__(self, redis_url=redis_url)
